...
def depth_2_color_space(
    ...
    depthXYs = depthXYs.view(np.float32).reshape(
        depthXYs.shape + (-1,)
...
def color_point_2_depth_point(kinect, depth_space_point, depth_frame_data):
    """
...
def intrinsics(
    kinect, path="intrinsics_retrieved_from_kinect_mapper.json", write=False
):
    """
    :param kinect: kinect instance
