class ChatGetter {
    ...
    async getMessagesFromSecOffset(secOffset) {
        await this.getChatFromSecOffset(secOffset).then(json => {
            // console.log(json);
    ...
    async getMessagesFromCursorOffset(cursorOffset) {
        ...
        for(var i = 0; i < json.data.video.comments.edges.length; i++) {
            var node = json.data.video.comments.edges[i].node;
            var message = ChatGetter.createChatElement(node);
...
// eyJpZCI6IjEzZmQ2MzI3LTVmZmItNGY0MS1hOTdhLTdkZmVlNDE5NWZiMyIsImhrIjoiYnJvYWRjYXN0OjQ2MTA4ODIwMjUyIiwic2siOiJBQUFBRjJfYzkwQVhHSHFINHdBQVFBIn0
// eyJpZCI6IjEzZmQ2MzI3LTVmZmItNGY0MS1hOTdhLTdkZmVlNDE5NWZiMyIsImhrIjoiYnJvYWRjYXN0OjQ2MTA4ODIwMjUyIiwic2siOiJBQUFBRjJfYzkwQVhHSHFINHdBQVFBIn0

// eyJpZCI6IjU3NDk3N2MzLWM0ODgtNDAyZS05N2FkLTg3NjUzOGM1MGM1NCIsImhrIjoiYnJvYWRjYXN0OjQ2MTA4ODIwMjUyIiwic2siOiJBQUFBSkJEZzhZQVhHSHFVaEFQNmdBIn0
// eyJpZCI6IjU3NDk3N2MzLWM0ODgtNDAyZS05N2FkLTg3NjUzOGM1MGM1NCIsImhrIjoiYnJvYWRjYXN0OjQ2MTA4ODIwMjUyIiwic2siOiJBQUFBSkJEZzhZQVhHSHFVaEFQNmdBIn0