...
<nav class="navbar navbar-expand navbar-dark" style="background-color: #292b45; font-size: var(--font-size-5)">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item mt-1">
                <?= ($_SERVER["REQUEST_URI"] == "/websites-multicurl-test.php") ? navLink("Websites Multi Curl", "/websites-multicurl-test.php", true) : navLink("Websites Multi Curl", "/websites-multicurl-test.php", false) ?>
            </li>
        </ul>
